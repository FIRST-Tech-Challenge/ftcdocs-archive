...
project = 'FIRST Tech Challenge Docs Archive'
copyright = 'FIRST'
...
intersphinx_mapping = {
    ...
    'ftcdocs': ('https://ftc-docs.firstinspires.org/en/latest/', None),
}
...
output_name = 'ftcdocs-archive'

# Admonition for archive status

rst_prolog = """.. attention::
    This documentation is for an archived content. For the most up-to-date information, please visit the current `FTC Docs <https://ftc-docs.firstinspires.org/en/latest/>`_.
"""
