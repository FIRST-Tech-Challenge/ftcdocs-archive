AprilTag Challenges in DECODE presented by RTX :bdg-warning:`Legacy`
====================================================================

.. attention::
   This article covers the DECODE presented by RTX season (2025-2026) and
   describes that season's FIELD elements. The camera techniques it explains
   are not season-specific; for current guidance, see the |text|_.

.. _text: https://ftc-docs.firstinspires.org/en/latest/
.. |text| replace:: *FIRST* Tech Challenge documentation
...
3. On the GOALS, AprilTags can be used as a visual odometry system, using the
   ...
   :external+ftcdocs:doc:`AprilTag Localization <apriltag/vision_portal/apriltag_localization/apriltag-localization>`
